...
function VideoCard(props) {
  ...
  return (
    ...
    >
      {/* Thumbnail image with click event to navigate to the video watch page */}
      <img
      ...
      {/* Video details including title and channel */}
      <div style={{ width: props.rightWidth }} className='flex w-[100%] gap-x-3 items-start mt-2'>
        <div>
          {/* Video title with click event to navigate to the video watch page */}
          <h3
            onClick={() => pageRoute(`/watch/${props.videoId}`)}
          ...
          <div className='mt-1'>
            {/* Channel name with click event to navigate to the channel page */}
            <p
